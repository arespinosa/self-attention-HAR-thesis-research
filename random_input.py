...
with open(output_file, "w") as f:
    ...
    (train_x, train_y), (val_x, val_y), (test_x, test_y), raw_test_y = get_pamap2_data(verbose=True)
    ...
    print_and_write(f, "Sample input shape (window_size x features):", sample_x.shape)
    ...
    model = tf.keras.models.load_model('saved_model/pamap2')  # adjust path if needed
